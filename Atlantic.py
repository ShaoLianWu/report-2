...
def BrooklynNets():
  ...
  with col2:
     ...
     st.subheader('老闆:John Abbamondi')
     st.subheader('GM:Sean Marks')
     st.subheader('總教練:Jacque Vaughn')     
...
def TorontoRaptors():
  ...
  with col2:
     ...
     st.subheader('老闆:Masai Ujiri')
     st.subheader('GM:Bobby Webster')
     st.subheader('總教練:Nick Nurse')     
