...
def Golden_State_Warriors():   #勇士
  ...
  st.write('費城勇士（1946年至1962年）-舊金山勇士（1962年至1971年）-金州勇士（1971年-至今）') 
...
def Los_Angeles_Clippers():   #快艇
  ...
  st.write('水牛城勇士（1970年至1978年）-聖地牙哥快艇（1978年至1984年）-洛杉磯快艇（1984年-至今）')
...
def Los_Angeles_Lakers():   #湖人
  ...
  st.write('底特律寶石(1946年至1947年)-明尼亞波利斯湖人(1947年至1959年)-洛杉磯湖人(1960年-至今')
